    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                input = req.body;
                return [4 /*yield*/, (0, index_1.execute)(input)];
            case 1:
                result = _a.sent();
                res.json(result);
                return [3 /*break*/, 3];
...
app.listen(PORT, function () {
    console.log("\uD83D\uDE80 GitHub Trends Skill \u670D\u52A1\u5DF2\u542F\u52A8: http://localhost:".concat(PORT));
    console.log("\uD83D\uDCE1 \u7AEF\u70B9: POST http://localhost:".concat(PORT, "/execute"));
});
exports.default = app;
